...
public class CannabisSourceFileMetaData implements Serializable {
    private static Logger LOG = LoggerFactory.getLogger(CannabisSourceFileMetaData.class);
    ...
    public static List<CannabisSourceFileMetaData> fromCSVLine(String csvLine) {
        try {
            ...
            LOG.warn(String.format("Line %s cannot be parsed", csvLine));
    ...
    public String generateGCSBlobName() {
        ...
        runName += ".fastq";
        return cannabisSourceMetaData.getDirPrefix() + runName;
    }
