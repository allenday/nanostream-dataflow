...
import com.google.allenday.nanostream.subprocess.configuration.SubProcessConfiguration;
...
public class FileUtils {
  ...
  public static boolean mkdir(String path) {
    LOG.info(String.format("Creating dir for file %s", path));
    Path dir;
    ...
    try {
      if (!Files.exists(dir)) {
        ...
        LOG.info(String.format("Dir %s already exists", dir.toString()));
      }
