...
public class Configuration {
    ...
    public final static String BAM_DATA_FOLDER_NAME = "bam";
    public final static String BAM_SORTED_DATA_FOLDER_NAME = "bam_sorted";
    public final static String BAM_INDEX_DATA_FOLDER_NAME = "bam_index";
    ...
    public static final long SAMTOOLS_DELAY_MILISEC = TimeUnit.HOURS.toMillis(4);
    public static final int SAMTOOLS_CHECK_DELAY_DELTA_MILISEC = 10000;
