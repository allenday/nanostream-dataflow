...
CUSTOM_COMMANDS = [
    ...
    'tar -xvjf minimap2-2.17_x64-linux.tar.bz2 -C /',
    'gsutil cp -r gs://cannabis-3k/reference/ /',
]
...
REQUIRED_PACKAGES = [
    'google-cloud-storage', 'pysam'
]

setuptools.setup(
    name='nanostream_cannabis',
    version='0.0.2',
    description='Nanostream Cannabis set workflow package.',
